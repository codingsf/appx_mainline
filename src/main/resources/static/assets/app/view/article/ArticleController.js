...
Ext.define("Demo.view.article.ArticleController", {
	extend: "Ext.app.ViewController",
	alias: "controller.article",
	
	uses: ["Demo.view.article.ArticleWin"],
	...
	//新增
	add: function() {
		var win = Ext.create("Demo.view.article.ArticleWin");
		win.show();
	},
	...
	edit: function(grid, rowIndex, colIndex) {
		...
		var win = Ext.create("Demo.view.user.UserWin", {
