...
public class Api_ScheduleJobController extends BaseController {
    ...
    @GetMapping
    public Object list(@RequestParam(value = "pageNum", defaultValue = "1") int pageNum, @RequestParam(value = "pageSize", defaultValue = "20") int pageSize) {
        return scheduleJobService.findPage(pageNum,pageSize);
    }
